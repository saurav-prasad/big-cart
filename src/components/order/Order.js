                                ...
                                >
                                    <div className="flex flex-1 items-stretch">
                                        ...
                                        <div className="ml-5 flex w-full flex-col justify-between">
                                            <div className="flex-1">
                                                <p className="text-sm text-left font-bold text-gray-900">{product.name}</p>
                                            </div>

                                            <p className="mt-4 text-sm text-left font-medium text-gray-500">Qnt: {product.quantity}</p>
                                        </div>
                                    </div>
