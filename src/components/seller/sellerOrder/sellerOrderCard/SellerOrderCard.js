...
function SellerOrderCard({ products, address, orderDetails }) {
    // console.log(products, orderDetails);
    const a = new Date(orderDetails?.date.seconds * 1000)
    return (
        <div className="mb-14 flex flex-col overflow-hidden rounded-lg border border-gray-300 md:flex-row bg-white">
            <div className="w-full border-r px-3  border-gray-300 bg-gray-50 md:max-w-xs">
                ...
                <hr className="mb-8" />
                {/* Contact Info */}
                <div className="px-5 pb-6 bg-gray-50 md:px-8">
